...
@Component({
    ...
    templateUrl: './ot-preoperation.component.html',
    styleUrls: ['./ot-preoperation.component.scss'],
    encapsulation: ViewEncapsulation.None,
    animations: fuseAnimations
})
export class OtPreoperationComponent {
    ...
    constructor(
        public _OTPreOperationService: OtPreoperationService,
    ...
    ngOnInit(): void {
        this.myFilterform = this._OTPreOperationService.createSearchForm();
    }
