...
@Component({
    ...
    templateUrl: './theater-in.component.html',
    styleUrls: ['./theater-in.component.scss'],
    encapsulation: ViewEncapsulation.None,
    animations: fuseAnimations
})
export class TheaterInComponent {
    ...
    ngOnInit(): void {
        this.myFilterform = this._TheaterinService.createSearchForm();
    }
