...
public getServicedetailList(params) {

         return this._httpClient.GetData("Dashboard/Lab-Financial-Department-Summary?UnitId=" + params.UnitId + "&GroupId=" + params.GroupId +"&FromDate=" + params.FromDate + "&ToDate=" + params.ToDate);
