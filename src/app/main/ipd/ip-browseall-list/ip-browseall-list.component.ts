...
import { BrowseAlllistService } from './browse-alllist.service';
...
@Component({
  selector: 'app-ip-browseall-list',
  templateUrl: './ip-browseall-list.component.html',
  styleUrls: ['./ip-browseall-list.component.scss'],
  encapsulation: ViewEncapsulation.None,
  animations: fuseAnimations
})
export class IPBrowseallListComponent implements OnInit {
  ...
  dataSource2 = new MatTableDataSource<IpdAdvanceBrowseModel>();




  constructor(public _IpBillBrowseListService: BrowseAlllistService,
...
<div style="display:flex;margin:8px 0">
  ...
  onShow_IpdAdvance(){
    ...
    // this._IpBillBrowseListService.getIpdAdvanceBrowseList(D_data).subscribe(Visit=> {
