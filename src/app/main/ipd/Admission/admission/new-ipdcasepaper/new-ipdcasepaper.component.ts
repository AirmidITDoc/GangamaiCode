...
import { MedicineTableNewComponent } from 'app/main/opd/new-casepaper/medicine-table-new/medicine-table-new.component';
import { certificateTemp } from 'app/main/opd/medicalrecord/patientcertificate/patientcertificate.component';
import { AddItemComponent } from 'app/main/opd/new-casepaper/add-item/add-item.component';
import { PrePresciptionListComponent } from 'app/main/opd/new-casepaper/pre-presciption-list/pre-presciption-list.component';
...
@Component({
  selector: 'app-new-ipdcasepaper',
  templateUrl: './new-ipdcasepaper.component.html',
  styleUrls: ['./new-ipdcasepaper.component.scss']
})
export class NewIPDCasepaperComponent {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<NewIPDCasepaperComponent>,
  ...
  ngOnInit(): void {
    ...
    if (this.data) {
      ...
      this.vOPIPId = this.regObj.admissionId
      this.VisitId = this.regObj.admissionId
...
export class CasepaperVisitDetails {
  ...
  constructor(casePaperDetails) {
    ...
    this.admissionId = casePaperDetails.admissionId || 0;
