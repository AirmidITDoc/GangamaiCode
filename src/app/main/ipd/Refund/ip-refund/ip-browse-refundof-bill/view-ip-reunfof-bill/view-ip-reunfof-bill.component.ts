...
@Component({
  ...
  templateUrl: './view-ip-reunfof-bill.component.html',
  styleUrls: ['./view-ip-reunfof-bill.component.scss']
})
export class ViewIPReunfofBillComponent implements OnInit {
...
outputWords=''
  ...
  constructor(private advanceDataStored: AdvanceDataStored,
    ...
    public _BrowseIPDRefundbillService:IPBrowseRefundofBillService,
