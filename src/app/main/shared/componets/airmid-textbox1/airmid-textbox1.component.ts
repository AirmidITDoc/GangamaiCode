...
@Component({
  selector: 'app-airmid-textbox1',
  templateUrl: './airmid-textbox1.component.html',
  styleUrls: ['./airmid-textbox1.component.scss'],
  providers: [
    // {
...
export class AirmidTextbox1Component implements 
  ...
  @HostBinding()
  id = `input-control-${++AirmidTextbox1Component.nextId}`;
