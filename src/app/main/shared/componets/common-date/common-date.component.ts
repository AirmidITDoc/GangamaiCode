...
export class CommonDateComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        if (this.screenFromString == 'admission-form') {
        ...
        else if(this.screenFromString == 'otBooking-form'){
            this.dateLabel = 'OTBooking Date';
            this.timeLabel = 'OTBooking Time';
            this.isDatePckrDisabled = false;
        }
        else if(this.screenFromString == 'Phoneappointment-form'){
            this.dateLabel = 'Appointment Date';
            this.timeLabel = 'Appointment Time';
            this.isDatePckrDisabled = false;
        }
           ...
           else if(this.screenFromString == 'physio-form'){
            this.dateLabel = 'Physio Date';
