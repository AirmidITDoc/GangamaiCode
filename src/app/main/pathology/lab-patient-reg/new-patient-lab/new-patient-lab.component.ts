...
@Component({
  selector: 'app-new-patient-lab',
  templateUrl: './new-patient-lab.component.html',
  styleUrls: ['./new-patient-lab.component.scss'],
    encapsulation: ViewEncapsulation.None,
    animations: fuseAnimations
})
export class NewPatientLabComponent {
 ...
 myForm: FormGroup
  ...
  constructor(public _labPatientRegService: LabPatientRegService,
    ...
    public dialogRef: MatDialogRef<NewPatientLabComponent>,
...
myFormGroup:FormGroup
  ...
  labRequestInsertForm(): FormGroup {
    ...
    return this._formbuilder.group({
      ...
      isAddedBy: [this.accountService.currentUserValue.userId, [this._FormvalidationserviceService.onlyNumberValidator()]],
      isCancelled: false,
      isCancelledBy: 0,
 ...
 vAdmissionID=0
  OnSave() {
    ...
    if (!this.labRequestInsert.invalid) {
      ...
      this._labPatientRegService.LabRequestSave(this.labRequestInsert.value).subscribe(response => {
        if (response) {
