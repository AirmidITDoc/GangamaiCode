    ...
    GetDetails1(data: any): void {
        ...
        this.gridConfig1 = {
            ...
            columnsList: [
                ...
                { heading: "Total Amt", key: "landedTotalAmount", sort: true, align: 'left', emptySign: 'NA', type: gridColumnTypes.amount },
                { heading: "GST%", key: "gstPercentage", sort: true, align: 'left', emptySign: 'NA' },
                { heading: "GST Amount", key: "gstAmount", sort: true, align: 'left', emptySign: 'NA', type: gridColumnTypes.amount },
                { heading: "Net Amount", key: "netAmount", sort: true, align: 'left', emptySign: 'NA', type: gridColumnTypes.amount }, //landedTotalAmount if i provide same name then shows error
