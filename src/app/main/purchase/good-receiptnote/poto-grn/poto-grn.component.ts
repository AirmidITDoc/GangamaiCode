...
export class POtoGRNComponent implements OnInit {
    ...
    AllColumnsDetails = [
        ...
        { heading: "Free Qty", key: "freeQty", sort: true, align: 'left', emptySign: 'NA', width: 100 },
        ...
        { heading: "Grand Total Amt", key: "grandTotalAmount", sort: true, align: 'left', emptySign: 'NA', width: 130,type: gridColumnTypes.amount  },
