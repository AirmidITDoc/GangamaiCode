...
vExpDate1:any='';
  OnSave() {
    ...
    this.dsItemNameList.data.forEach((element) => {
      ...
      openingBalanceParamInsertObj['perUnitPurRate'] = parseFloat(element.PerRate) || 0
      openingBalanceParamInsertObj['perUnitMrp'] = parseFloat(element.UnitMRP) || 0
      openingBalanceParamInsertObj['vatPer'] = parseFloat(element.GST) || 0
