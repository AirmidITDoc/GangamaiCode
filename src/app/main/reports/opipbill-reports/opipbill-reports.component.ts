...
import { OPIPBillreportService } from './opipbillreport.service';
...
import { PharmacyreportService } from '../pharmacy-report/pharmacyreport.service';

@Component({
  selector: 'app-opipbill-reports',
  templateUrl: './opipbill-reports.component.html',
  styleUrls: ['./opipbill-reports.component.scss']
})
export class OPIPBillReportsComponent implements OnInit {
