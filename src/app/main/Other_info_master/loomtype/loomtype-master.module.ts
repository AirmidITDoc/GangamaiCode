...
import { LoomtypeComponent } from './loomtype.component';
...
const appRoutes: Routes = [
    ...
    {
      path: "**",
      component: LoomtypeComponent
  },
  {
    // Beam
     path: "Other Info Master/LoomType",
     loadChildren: () => LoomtypeComponent
...
export class LoomtypeMasterModule { }
