...
import { MrdTemplateComponent } from "./mrd-template.component";
import { NewMrdTemplateComponent } from './new-mrd-template/new-mrd-template.component';

const routes: Routes = [
  {
    path: "**",
    component: MrdTemplateComponent,
  },
];

@NgModule({
  declarations: [MrdTemplateComponent, NewMrdTemplateComponent],
  imports: [
...
export class MrdTemplateModule { }
