...
@Component({
    selector: 'app-new-spec-preservative-master',
    templateUrl: './new-spec-preservative-master.component.html',
    styleUrls: ['./new-spec-preservative-master.component.scss'],
    encapsulation: ViewEncapsulation.None,
    animations: fuseAnimations,
})
export class NewSpecPreservativeMasterComponent {
    specimenForm: FormGroup;
    isActive: boolean = true;

    constructor(
        public _specimenService: SpecPreservativeMasterService,
        public dialogRef: MatDialogRef<NewSpecPreservativeMasterComponent>,
    ...
    ngOnInit(): void {
        ...
        if ((this.data?.specimenPreservativeId ?? 0) > 0) {
    ...
    getValidationMessages() {
        return {
            preservativeUsed: [
                { name: "required", Message: "Specimen Preservative is required" },
