...
import { InvMillMasterComponent } from './inv-mill-master/inv-mill-master.component';
...
@Component({
  selector: 'app-inv-mill',
  templateUrl: './inv-mill.component.html',
  styleUrls: ['./inv-mill.component.scss'],
  encapsulation: ViewEncapsulation.None,
  animations: fuseAnimations
})
export class InvMillComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    var D_data = {
      ...
      "millName": this._InvoiceListService.mySearchform.get("millName").value + '%' || '%',
  ...
  NewMillmaster() {
    const dialogRef = this._matDialog.open(InvMillMasterComponent,
      {
        maxWidth: "45vw",
        height: '400px',
        width: '100%',
