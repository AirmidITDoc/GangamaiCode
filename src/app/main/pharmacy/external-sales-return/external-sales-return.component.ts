...
import { Component, OnInit, ViewChild, ViewEncapsulation,Inject, ElementRef, HostListener } from '@angular/core';
...
import { OpeningBalanceService } from 'app/main/purchase/opening-balance/opening-balance.service';
import { NewOpeningBalanceComponent } from 'app/main/purchase/opening-balance/new-opening-balance/new-opening-balance.component';
import { GRNFormModel, GRNItemResponseType, ToastType } from 'app/main/purchase/good-receiptnote/new-grn/types';  
...
@Component({
  selector: 'app-external-sales-return',
  templateUrl: './external-sales-return.component.html',
  styleUrls: ['./external-sales-return.component.scss'],
  encapsulation: ViewEncapsulation.None,
  animations: fuseAnimations,
})
export class ExternalSalesReturnComponent implements OnInit { 
