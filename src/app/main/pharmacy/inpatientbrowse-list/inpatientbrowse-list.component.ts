...
import { Component, ComponentRef, ElementRef, HostListener, TemplateRef, ViewChild } from '@angular/core';
...
@Component({
    selector: 'app-inpatientbrowse-list',
    templateUrl: './inpatientbrowse-list.component.html',
    styleUrls: ['./inpatientbrowse-list.component.scss']
})
export class InpatientbrowseListComponent {
    ...
    constructor(
        ...
        public _BrowsSalesBillService: InpatientbrowseListService,
    ...
    getsalesdetaillist(event) {
        ...
        this.gridConfig1 = {
            apiUrl: "InPatient/SalesInPatientDetailsList",
    ...
    getchangeDate() {
        ...
        if (this._BrowsSalesBillService.SalesPatientForm.get('IsDischarge').value != false) {
            this.apiUrl = "InPatient/AdmissionDischargeList"
            this.Fr_Date = this.datePipe.transform(this._BrowsSalesBillService.SalesPatientForm.get('startdate1').value, "yyyy-MM-dd") || "1900-01-01"
            this.T_Date = this.datePipe.transform(this._BrowsSalesBillService.SalesPatientForm.get('enddate1').value, "yyyy-MM-dd") || "1900-01-01"
            this.status = '1'
        }
    ...
    onChangeDiscahrge(event) {
        ...
        if (this._BrowsSalesBillService.SalesPatientForm.get('IsDischarge').value == false) {
            ...
            this.T_Date = "1900-01-01"
            this.status = '0'
            this.apiUrl = "Admission/AdmissionDischargeListt"
        } else {
    ...
    printsalesDetails(contact) {
        ...
        setTimeout(() => {
            const param = {
                ...
                "mode": "PharmacyInPatientSalesDetails"
            }
    ...
    printsalesPatientstatement(contact) {
        setTimeout(() => {
            const param = {
                ...
                "mode": "PharmacyInPatientStatement"
            }
            this._BrowsSalesBillService.getReportView(param).subscribe(res => {
                const dialogRef = this._matDialog.open(PdfviewerComponent,
                    {
