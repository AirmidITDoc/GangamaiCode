...
@Component({
  selector: 'app-new-sales-disc-update',
  templateUrl: './new-sales-disc-update.component.html',
  styleUrls: ['./new-sales-disc-update.component.scss']
})
export class NewSalesDiscUpdateComponent {
 MyFrom: FormGroup;
    saveform: FormGroup;
    ...
    constructor(
        ...
        public dialogRef: MatDialogRef<NewSalesDiscUpdateComponent>,
    ...
    ngOnInit(): void {
        if (this.data) {
            ...
            this.prevDiscper = ((this.vDiscAmount) / this.vTotalAmount * 100).toFixed(1)
        }
