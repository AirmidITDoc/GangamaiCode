...
import { IpPharmacyAdvanceReturnService } from './ip-pharmacy-advance-return.service';
...
@Component({
  selector: 'app-ip-pharmacy-advance-return',
  templateUrl: './ip-pharmacy-advance-return.component.html',
  styleUrls: ['./ip-pharmacy-advance-return.component.scss'],
  encapsulation: ViewEncapsulation.None,
  animations: fuseAnimations,
  
})
export class IpPharmacyAdvanceReturnComponent implements OnInit {
  ...
  constructor(
    public _IndentID: IpPharmacyAdvanceReturnService,
