...
export class SalesHospitalKenyaComponent {
    ...
    createItemAddTable() {
        return this.formBuilder.group({
            ...
            GSTPer: [((this.selectedItem?.cgstPer || 0) + (this.selectedItem?.sgstPer || 0) + (this.selectedItem?.igstPer || 0)), [this._FormvalidationserviceService.AllowDecimalNumberValidator()]],
            ...
            CgstPer: [this.selectedItem?.cgstPer || 0, [this._FormvalidationserviceService.AllowDecimalNumberValidator()]],
            CGSTAmt: [0, [this._FormvalidationserviceService.AllowDecimalNumberValidator()]],
            SgstPer: [this.selectedItem?.sgstPer || 0, [this._FormvalidationserviceService.AllowDecimalNumberValidator()]],
            SGSTAmt: [0, [this._FormvalidationserviceService.AllowDecimalNumberValidator()]],
            IgstPer: [this.selectedItem?.igstPer || 0, [this._FormvalidationserviceService.AllowDecimalNumberValidator()]],
