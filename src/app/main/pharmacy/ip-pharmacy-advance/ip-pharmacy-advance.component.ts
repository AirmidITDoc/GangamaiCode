...
import { IpPharmacyAdvanceService } from './ip-pharmacy-advance.service';
...
@Component({
  selector: 'app-ip-pharmacy-advance',
  templateUrl: './ip-pharmacy-advance.component.html',
  styleUrls: ['./ip-pharmacy-advance.component.scss'],
  encapsulation: ViewEncapsulation.None,
  animations: fuseAnimations,
  
})
export class IpPharmacyAdvanceComponent implements OnInit {
  ...
  constructor(
    public _IndentID: IpPharmacyAdvanceService,
