...
@Component({
  selector: 'app-discount-after-final-labbill',
  templateUrl: './discount-after-final-labbill.component.html',
  styleUrls: ['./discount-after-final-labbill.component.scss'],
  encapsulation: ViewEncapsulation.None,
  animations: fuseAnimations,
})
export class DiscountAfterFinalLabbillComponent {
  MyFrom: FormGroup;
  saveform: FormGroup;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<DiscountAfterFinalLabbillComponent>,
  ...
  OnSave() {
    ...
    let BalAmt = this.PatientObj?.balanceAmt
    if (formvalues?.DiscAmount2 > 0) {
      BalAmt = formvalues?.NetAmount
    }

    this.saveform.get('billNo').setValue(this.PatientObj?.billNo)
