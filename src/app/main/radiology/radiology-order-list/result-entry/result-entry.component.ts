      ...
      if (!this.selectedAdvanceObj.RadReportId) {
        var m_data = {
          insertRadiologyTemplateMaster: {
            ...
            "IsCompleted":'true', 
            "IsPrinted":'true', 
            "RadResultDr1":0,// this._radiologytemplateService.myform.get("DoctorId").value.DoctorId || 10005,
            "RadResultDr2":0, 
            "RadResultDr3":0, 
        ...
        var m_dataUpdate = {
          radiologyReportHeaderUpdate: {
            ...
            "IsCompleted": true, 
            "IsPrinted": true, 
            "RadResultDr1":0,//this._radiologytemplateService.myform.get("DoctorId").value.DoctorId || 0,
            "RadResultDr2": 0, 
            "RadResultDr3": 0, 
