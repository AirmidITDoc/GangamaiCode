    ...
    getSelectedRow(row: any): void {
        ...
        this.gridConfig1 = {
            ...
            columnsList: [
                ...
                { heading: "PerUnitPurchase", key: "perUnitPurchaseRate", sort: true, align: 'left', emptySign: 'NA', width: 150, type: gridColumnTypes.amount  },
                { heading: "PerUnitLandedRate", key: "perUnitLandedRate", sort: true, align: 'left', emptySign: 'NA', width: 150, type: gridColumnTypes.amount  },
                { heading: "PerUnitMRPRate", key: "perUnitMRPRate", sort: true, align: 'left', emptySign: 'NA', width: 150, type: gridColumnTypes.amount  },
                { heading: "PurTotalAmt", key: "purTotalAmount", sort: true, align: 'left', emptySign: 'NA', width: 150, type: gridColumnTypes.amount  },
                { heading: "LandedTotalAmt", key: "landedTotalAmount", sort: true, align: 'left', emptySign: 'NA', width: 150, type: gridColumnTypes.amount  },
                { heading: "MRPTotalAmt", key: "mrpTotalAmount", sort: true, align: 'left', emptySign: 'NA', width: 150 , type: gridColumnTypes.amount },
