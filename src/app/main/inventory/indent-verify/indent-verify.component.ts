...
import { IndentVerifyService } from './indent-verify.service';

@Component({
  selector: 'app-indent-verify',
  templateUrl: './indent-verify.component.html',
  styleUrls: ['./indent-verify.component.scss'],
  encapsulation: ViewEncapsulation.None,
  animations: fuseAnimations,
})
export class IndentVerifyComponent {
  ...
  Status = "0"
  FromStore: any = "0";
  Tostore: any = String(this.accountService.currentUserValue.user.storeId)
  IsVerify = "0"
  IsActive = "0"
  IsClosed = "0"
  IsIndentVerify: any;
  ...
  constructor(
    public _IndentService: IndentVerifyService, private commonService: PrintserviceService,
