...
@Component({
  ...
  templateUrl: './op-settlement.component.html',
  styleUrls: ['./op-settlement.component.scss']
})
export class OPSettlementComponent implements OnInit {
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<OPSettlementComponent>,
