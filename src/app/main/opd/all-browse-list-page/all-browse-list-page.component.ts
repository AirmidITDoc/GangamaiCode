...
@Component({
  selector: 'app-all-browse-list-page',
  templateUrl: './all-browse-list-page.component.html',
  styleUrls: ['./all-browse-list-page.component.scss'],
  encapsulation: ViewEncapsulation.None,
  animations: fuseAnimations
})
export class AllBrowseListPageComponent implements OnInit {
...
reportPrintObj1: BrowseOpdPaymentReceipt;
displayedColumns1 = [
...
dataSource2 = new MatTableDataSource<RefundMaster>();
  ...
  constructor(private _fuseSidebarService: FuseSidebarService,
    public _BrowseOPDBillsService: AllBrowseListpageService,
  ...
  onClear() {
    ...
    this._BrowseOPDBillsService.myFilterform.get('ReceiptNo').reset();
  }
...
// changes.prop contains the old and the new value...
// console.log(changes.dataArray.currentValue, 'new arrrrrrr');
this.dataSource1.data = changes.dataArray.currentValue as BrowseOpdPaymentReceipt[];
this.dataSource.sort =this.sort;
this.dataSource.paginator=this.paginator;
}
