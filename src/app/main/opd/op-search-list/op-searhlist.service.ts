...
export class OPSearhlistService {
    ...
    public InsertOPBillingCredit(Param: any) {
        // if (Param.refundId) {

        return this._httpClient1.PostData("Billing/OPCreditBillingInsert", Param);
        // }
    ...
    public InsertOPRefundBilling(Param: any) {
        if (Param.refundId) {
            return this._httpClient1.PutData("RefundOfBill/IPInsert" + Param.refundId, Param);
        }
        //  else return this._httpClient1.PostData("RefundOfBill/IPInsert", Param, showLoader);
    }
    ...
    // new Api
    public OpBillInsertSave(Param: any) {
        if (Param.phoneAppId) {
            return this._httpClient1.PutData("Billing/OPBillingInsert" + Param.phoneAppId, Param);
        } else return this._httpClient1.PostData("Billing/OPBillingInsert", Param);
    }
