...
import { BrowseOPDBill } from '../browse-opbill.component';
...
@Component({
  ...
  templateUrl: './view-opbill.component.html',
  styleUrls: ['./view-opbill.component.scss'],
  encapsulation: ViewEncapsulation.None,
  animations: fuseAnimations
})
export class ViewOPBillComponent implements OnInit {
