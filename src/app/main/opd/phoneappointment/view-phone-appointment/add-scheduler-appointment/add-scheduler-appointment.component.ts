...
@Component({
  ...
  templateUrl: './add-scheduler-appointment.component.html',
  styleUrls: ['./add-scheduler-appointment.component.scss'],
  encapsulation: ViewEncapsulation.None,
  animations: fuseAnimations
})
export class AddSchedulerAppointmentComponent implements OnInit {
...
debugger
    ...
    var m_data = {
      "phoneAppointmentInsert": {
        ...
        "appEndTime": this.dateTimeObj.endtime,
